...
export type ModalType = 'appointment' | 'patient' | 'item' | 'medical' | 'delete' | 'status' | 'billing' | 'billing-details' | 'user' | 'blockedTimeSlot' | 'personnel' | 'restock' | 'addQuantity' | 'cancel';
