...
//                         // Block admin accounts from logging in through the user login page
//                         const { user } = get()
//                         if (user && user.userType === 'admin') {
//                             // Silently log them back out on the backend so activeToken is cleared
...
//                                 user: null,
//                                 validationErrors: {
//                                     emailOrContactNumber: 'Doctors and Staff are not allowed to log in here. Please use the Admin portal.'
//                                 }
//                             })
//                             return
//                         }
                ...
                login: async (credentials) => {
                    try {
                        ...
                        if (user && user.userType === 'admin') {
                            ...
                            toast.error('Doctors and Staff are not allowed to log in here. Please use the Admin portal.')
                            return
                        }
