...
const validateStatusUpdate = [
    ...
    body('status')
        ...
        .isIn(['Pending', 'Scheduled', 'Referred', 'Completed', 'Cancelled', 'Rebooked', 'CancellationRequested'])
        .withMessage('Status must be one of: Pending, Scheduled, Referred, Completed, Cancelled, Rebooked, CancellationRequested'),
